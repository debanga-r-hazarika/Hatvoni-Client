                      ...
                      <div className="p-6 md:p-8 lg:p-10">
                        <div className="flex flex-wrap items-start justify-between gap-4 md:gap-6 mb-6 md:mb-10 pb-6 md:pb-8 border-b border-outline-variant/30">
                          ...
                          <div className="space-y-1 min-w-[100px]">
                            ...
                            <p className="font-headline font-bold text-secondary text-lg md:text-xl">₹{order.total_amount}</p>
                          </div>
                            ...
                            {order.order_items?.length > 0 ? (
                              order.order_items.map(item => (
                                <div key={item.id} className="flex-shrink-0 group">
                                  ...
                                  <p className="text-xs font-bold leading-tight max-w-[96px] md:max-w-[128px]">{item.products?.name}</p>
